...
from templete2.models import UploadedFile,generatequotation
from templete2.forms import PDFForm,quotationform,pricescheduleform
...
# style normal
            ...
            if pdfdata_form.cleaned_data.get('include_selfdeclarationletter'):
                ...
                if pdf_data.letterhead:
                    ...
                    p.drawImage(letterhead_path, 10, height - 100, width=580, height=100)
                ...
                body_text = """
                    ...
                    the organization. We Palpasa Enterprises Pvt. Ltd. declare that we are eligible to participate 
                ...
                if pdf_data.signature:
                    ...
                    p.drawImage(signature_path, 50, y_position-60, width=150, height=100)
                ...
                p.line(40, line_y_position, width-400, line_y_position)
            ...
            # Warranty commitment letter page
                ...
                commitment_text = f"""
                    Dear Sir/Madam,<br/>
                    &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;This refers to your Tender for <b>The Procurement of {pdf_data.subject}.</b> We, Palpasa Enterprises Pvt. Ltd., declare that we are eligible to participate 
                ...
                if pdf_data.signature:
                    signature_path = os.path.join(settings.MEDIA_ROOT, pdf_data.signature.name)
                    p.drawImage(signature_path, 50, y_position - 60, width=150, height=120)
                    y_position -= 60  # Adjust y position below the signature image
                else:
                    y_position -= 60
            ...
            # Warranty commitment letter page
                ...
                commitment_text = f"""
                    Dear Sir/Madam,<br/>
                    &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;This refers to your tender for <b> The Procurement of {pdf_data.subject}</b>. We, Palpasa Enterprises Pvt. Ltd., declare that the offered equipment shall
                ...
                if pdf_data.signature:
                    signature_path = os.path.join(settings.MEDIA_ROOT, pdf_data.signature.name)
                    p.drawImage(signature_path, 50, y_position - 80, width=150, height=120)
                    y_position -= 60  # Adjust y position below the signature image
                else:
                    y_position -=60  # Adjust y position below the signature image
            ...
            # Warranty commitment letter page
                ...
                commitment_text = f"""
                    Dear Sir/Madam,<br/>
                    &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;This refers to your tender for <b> The Procurement of {pdf_data.subject}</b>. We, Palpasa Enterprises Pvt. Ltd., declare that We Sharvil Energy Pvt.Ltd., if we are awarded the
            ...
            # Warranty commitment letter page
                ...
                commitment_text = f"""
                    Dear Sir/Madam,<br/>
                    &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;This refers to your tender for <b> The Procurement of {pdf_data.subject}</b>. We, Palpasa Enterprises Pvt. Ltd. If we are awarded the contract installation &amp;
            ...
            # Warranty commitment letter page
                ...
                commitment_text = f"""
                    Dear Sir/madam,<br/>
                    &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;We, Palpasa Enterprises Pvt. Ltd. Here by to assign {pdf_data.proprietor_name} {pdf_data.ourdesignation} of this company to handle all tender and quotation related to <b> The Procurement of {pdf_data.subject}</b>.<br/> He is authorized to do all necessary documentation on our behalf and purpose.<br/> 
                  Thank you, <br/> Sincerely yours
                """
                elements.append(Paragraph(commitment_text, styles['BodyText']))
                ...
                if pdf_data.attornitysign:
                    ...
                    p.drawImage(attornitysign_path, 50, y_position - 80, width=150, height=120)
                    y_position -= 60  # Adjust y position below the signature image
                else:
                    y_position -=60  # Adjust y position below the signature image
...
# letter of technicxal bid
            ...
            # Warranty commitment letter page
                ...
                commitment_text = f"""
                    ...
                    schedule specified in the Section V (Schedule of Requirements), the following Goods and Related
                    Services: <b>The Procurement of {pdf_data.subject}.</b><br/><br/>
                    (c) The total price of our Bid, excluding any discounts offered in item (d) below, is: {vats_amt}(In Words {vat_words})<br/><br/>
            ...
            # Warranty commitment letter page
                ...
                p.drawString(50, y_position - 20, "Duly authorized to sign the bid for & on behalf of: Palpasa Enterprises Pvt. Ltd.")
                p.drawString(50, y_position - 40, f"Date:{pdf_data.date}")
                if pdf_data.footer:
                    y_position=height-771
                    print(y_position)
    ...
    return render(request, 'templete2/forms.html', {'pdfdata_form': pdfdata_form})
    ...
    if request.method == 'POST':
        ...
        if pdfdata_form.is_valid():
            ...
            if pdfdata_form.cleaned_data.get('include_selfdeclarationletter'):
                ...
                if pdf_data.letterhead:
                    header_path = os.path.join(settings.MEDIA_ROOT, pdf_data.letterhead.name)
                    
                    for section in document.sections:
                        section._sectPr.headerDistance = Inches(0.1)
                        header = section.header
                        
                        paragraph = header.paragraphs[0] if header.paragraphs else header.add_paragraph()
                        run = paragraph.add_run()
                        try:
                            run.add_picture(header_path, width=Inches(7.0))
                        except Exception as e:
                ...
                body_text = (
                    "Dear Sir/Madam,\n\n"
                    "This refers to you that related to the above subject with respect to the procurement procedure. "
                    "We Palpasa Enterprises Pvt. Ltd. declare that we are eligible to participate in the bidding process."
                    "We have no conflict of interest and no pending litigation.\n\nThank you,\n\nSincerely yours," 
                )
                document.add_paragraph(body_text)
                ...
                if pdf_data.footer:
                    ...
                    for section in document.sections:
                        ...
                        run = paragraph.add_run()
                        try:
                            run.add_picture(footer_path, width=Inches(7.0))
                        except Exception as e:
                            print(f"Error adding footer image: {e}")
                        
                        # Optional: Align the paragraph containing the image
                        paragraph.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
            ...
            if pdfdata_form.cleaned_data.get('include_warrantyletter'):
                ...
                body_text = (
                    f"Dear Sir/Madam,\n"
                    f"This refers to your Tender for <b>The Procurement of {pdf_data.subject}.</b> We, Fine Surgicals Nepal Pvt. Ltd., declare that we are eligible to participate "
            ...
            if pdfdata_form.cleaned_data.get('include_manufactureletter'):
                ...
                body_text = (
                    "Dear Sir/Madam,\n\n"
                    f"        This refers to your tender for **The Procurement of {pdf_data.subject}**. We, Palpasa Enterprises Pvt. Ltd., "
            ...
            if pdfdata_form.cleaned_data.get('include_deliverycommitmentletter'):
                ...
                body_text = (
                    ...
                    "We, Palpasa Enterprises Pvt. Ltd., declare that if we are awarded the "
            ...
            if pdfdata_form.cleaned_data.get('include_installationletter'):
                ...
                body_text = (
                    f"Dear Sir/Madam,\n\n"
                    f"        This refers to your tender for **The Procurement of {pdf_data.subject}**. "
                    "We, Palpasa Enterprises Pvt. Ltd., declare that if we are awarded the contract, "
            ...
            if pdfdata_form.cleaned_data.get('include_attorneyletter'):
                ...
                body_text = (
                    f"Dear Sir/Madam,\n\n"
                    f"        We, Palpasa Enterprises Pvt. Ltd., hereby assign {pdf_data.proprietor_name}, {pdf_data.ourdesignation} of this company, "
            ...
            if pdfdata_form.cleaned_data.get('include_pricebid'):
                ...
                document.add_paragraph("Duly authorized to sign the bid for & on behalf of: Fine Surgicals Nepal Pvt. Ltd.")
            ...
            if pdfdata_form.cleaned_data.get('include_quotationandprice'):
                ...
                document.add_paragraph(body_text)
                 ...
                 # Add bidder informati
                document.add_paragraph(f"Name: {pdf_data.proprietor_name}\n In the capacity of:{pdf_data.ourdesignation}\nSigned")
                # document.add_paragraph(f"In the capacity of: {pdf_data.ourdesignation}")
                # document.add_paragraph("Signed")
...
def calculate_column_widths(data, font_name="Helvetica", font_size=10, min_width=70, max_width=200):
    column_widths = []
...
def upload(request):
    ...
    return render(request, 'template2/priceschedule.html', {'pricescheduleform_form': pricescheduleform_form})
...
def generate_priceschedule(request):
    if request.method == 'POST':
        ...
        if pricescheduleform_form.is_valid():
            ...
            # story.append(Paragraph(f"In Words :{vat_words}", styles["BodyText"]))
            story.append(Paragraph(f"Notes*:{pdf_data.notes}", styles["BodyText"]))
            ...
            if pdf_data.signature:
                ...
                story.append(Paragraph(" ______________________", styles["BodyText"]))
                story.append(Paragraph(f"{pdf_data.propritername}", styles["BodyText"]))
                story.append(Paragraph(f"{pdf_data.designation}", styles["BodyText"]))
            else:
                story.append(Spacer(1, 20))
                story.append(Paragraph(" ______________________", styles["BodyText"]))
    ...
    return render(request, 'templete2/priceschedule.html', {'pricescheduleform_form': pricescheduleform_form})
...
def generate_quotation(request):
    if request.method == 'POST':
        ...
        """
            ...
            story.append(Paragraph(f"Dear sir/madam<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; We are delighted to inform you that we offer competitive prices of {pdf_data.paragraph} to meet your needs. We are confident that our rates will exceed your expectations. Please find attached a detailed price list for your reference. If you require any further information or would like to discuss your specific requirements, please do not hesitate to contact us.", styles['BodyText']))
            ...
            if pdf_data.excel:
                ...
                data = data.replace({pd.NA: None, np.nan: None})  # Handle NaN values
                def format_value(x):
            ...
            # story.append(Paragraph(f"In Words :{vat_words}", styles["BodyText"]))
            story.append(Paragraph(f"Notes*:{pdf_data.notes}", styles["BodyText"]))
            story.append(Paragraph(f"<b>Terms and conditions:</b><br/><br/>-{pdf_data.terms1}<br/>-{pdf_data.terms2}<br/>-{pdf_data.terms3}<br/>-{pdf_data.terms4}", styles["BodyText"]))
    ...
    return render(request, 'templete2/quotation.html', {'quotation_form': quotation_form})

# def quotation_docs(request):
    
def generate_quotation_docs(request):
    if request.method == 'POST':
        quotation_form = quotationform(request.POST, request.FILES)
        if quotation_form.is_valid():
            pdf_data = quotation_form.save()
            ...
            document.add_paragraph("Terms and Conditions:")
            for term in [pdf_data.terms1, pdf_data.terms2, pdf_data.terms3, pdf_data.terms4]:
                if term:
                    document.add_paragraph(f"- {term}")
